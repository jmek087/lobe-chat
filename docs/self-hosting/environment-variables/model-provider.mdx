...
- Type: Optional
- Description: Enables Vertex AI as a model provider by default, turns on the Vertex AI service when set to `1`
- Default: `0`
- Example: `1`
...
- Type: Required
- Description: This is the service account key you created in Google Cloud Platform, needs to be in a complete JSON string format
- Default: -
- Example: `{ "type": "service_account", "project_id": "your-project-id", "private_key_id": "key-id", "private_key": "-----BEGIN PRIVATE KEY-----\nYOUR_PRIVATE_KEY\n-----END PRIVATE KEY-----\n", ... }`

### `VERTEXAI_LOCATION`

- Type: Optional
- Description: Region setting for Vertex AI services
- Default: -
- Example: `us-central1`
...
- Type: Optional
- Description: Google Cloud project ID, can be omitted if already included in the credentials file
- Default: -
