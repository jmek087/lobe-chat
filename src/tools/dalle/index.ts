...
export const DalleManifest: BuiltinToolManifest = {
  ...
  systemRole: `Whenever a description of an image is given, use gpt-image-generator to create the images and then summarize the prompts used to generate the images in plain text. If the user does not ask for a specific number of images, default to creating four captions to send to gpt-image-generator that are written to be as diverse as possible.
